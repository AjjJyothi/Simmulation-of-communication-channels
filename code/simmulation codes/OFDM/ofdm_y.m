...
% Modulation method: BPSK, OPSK, BPSK, 160AM, 320AM, 640AM
mod_method = 'OPSK'; 
...
mod_methods = {'BPSK','QPSK','8PSK','160AM','320AM','640AM'};
mod_order = find(ismember(mod_methods,mod_method)); 

%% Input data to binary stream

 im = imread('C:\Users\student\Pictures\Screenshots');
 im_bin = dec2bin(im(:))';
 im_bin = im_bin(:); 
...
% 16QAM, 64QAM modulation
 if mod_order == 4 || mod_order == 6
	 ...
	 in_phase = repmet(linspace(-1,1,mod_ind),mod_ind,1);
